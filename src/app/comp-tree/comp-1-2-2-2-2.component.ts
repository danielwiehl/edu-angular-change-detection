...
const NAME = 'comp-1-2-2-2-2';
const LEVEL = 5;
const CD_STRATEGY = ChangeDetectionStrategy.Default;
const CHILD_TEMPLATE = `
  <app-comp-1-2-2-2-2-1 [inputByVal]="inputByVal" [inputByRef]="inputByRef" [inputObservable]="inputObservable"></app-comp-1-2-2-2-2-1>
`;
...
export class Comp_1_2_2_2_2_Component extends AbstractChangeDetectionComponent { // tslint:disable-line:class-name
