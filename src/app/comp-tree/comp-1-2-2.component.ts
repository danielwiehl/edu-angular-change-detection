...
const NAME = 'comp-1-2-2';
const LEVEL = 3;
const CD_STRATEGY = ChangeDetectionStrategy.OnPush;
const CHILD_TEMPLATE = `
  <app-comp-1-2-2-1 [inputByVal]="inputByVal" [inputByRef]="inputByRef" [inputObservable]="inputObservable"></app-comp-1-2-2-1>
  <app-comp-1-2-2-2 [inputByVal]="inputByVal" [inputByRef]="inputByRef" [inputObservable]="inputObservable"></app-comp-1-2-2-2>
`;
...
export class Comp_1_2_2_Component extends AbstractChangeDetectionComponent { // tslint:disable-line:class-name
