...
const NAME = 'comp-1-1-1';
const LEVEL = 3;
const CD_STRATEGY = ChangeDetectionStrategy.Default;
const CHILD_TEMPLATE = `
  <app-comp-1-1-1-1 [inputByVal]="inputByVal" [inputByRef]="inputByRef" [inputObservable]="inputObservable"></app-comp-1-1-1-1>
  <app-comp-1-1-1-2 [inputByVal]="inputByVal" [inputByRef]="inputByRef" [inputObservable]="inputObservable"></app-comp-1-1-1-2>
`;
...
export class Comp_1_1_1_Component extends AbstractChangeDetectionComponent { // tslint:disable-line:class-name
